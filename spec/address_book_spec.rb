...
RSpec.describe AddressBook do
  ...
  describe "#nuke" do
    it "should delete all entries" do
      book.add_entry("Andrew", "314-591-0949", "andrew@blocmail.com")
      book.add_entry("Andrew", "314-591-0949", "andrew@blocmail.com")
      book.add_entry("Andrew", "314-591-0949", "andrew@blocmail.com")
  ...
  describe "remove_entry" do
    it "removes an  entry using the name, phone_number, and email address" do
      book.add_entry('Andrew Allen', '314.595.0949', 'w.andrewallen@gmail.com')
      ...
      expect(book.entries.size).to eq 1
      expect(book.entries.first.name).to eq('Andrew Allen')
    end
  end
  ...
  describe "importing from entries_2.csv" do
    ...
    it "imports the 1st entry" do
      book.import_from_csv("entries_2.csv")
      check_entry(book.entries[0], "Karen", "636-248-0131", "karen@blocmail.com")
    end

    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      check_entry(book.entries[1], "Scott", "314-330-5914", "scott@blocmail.com")
    end

      it "imports the 3rd entry" do
       book.import_from_csv("entries_2.csv")
       check_entry(book.entries[2], "TJ", "314-822-5284", "tj@blocmail.com")
     end
   end
